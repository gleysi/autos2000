...
<form class="col-xs-12" id="formatable" action="" method="post" enctype="multipart/form-data">
	<table class="table table-striped">
			...
			<tr>
				...
				<td><input type="date" name="attr_fechafacoriginal" class="form-control" value="<?php if($feve) echo $att->att_fechafacoriginal;?>"></td>
			...
			<tr>	
				...
				<td><input type="text" name="attr_foliooriginal" class="form-control" value="<?php if($feve) echo $att->att_foliooriginal;?>"></td>
				<td>Expedida por:</td>
...
<?php
	...
	<div class="panel panel-primary">
		...
		<table class="table table-striped">
			<tr> <td>Id</td> <td>VU</td> <td>Fecha de registro</td>  <td>Vehículo</td> <td>Tipo</td> <td>Modelo</td>  <td>Acciones</td> </tr>
			<?php
				if ($usu->num_rows>0) {
